        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:48px 48px 32px;background-color:#FAF7F2;">
              <p style="margin:0 0 24px;font-family:Georgia,serif;font-style:italic;font-size:22px;color:#2C1A12;line-height:1.4;">You're in. Here's what that means.</p>
              <p style="margin:0 0 16px;font-family:Arial,sans-serif;font-size:15px;color:#6B5248;line-height:1.7;">You'll be the first to know where we pop up next, when new seasonal drinks drop, and everything Dirty. No clutter — just the good stuff.</p>
              <p style="margin:0 0 32px;font-family:Arial,sans-serif;font-size:15px;color:#6B5248;line-height:1.7;">Come find us this <strong style="color:#2C1A12;">Thursday at the SLO Farmers Market</strong> on Higuera Street — 6 to 9 PM. Pre-order ahead so you don't wait in line.</p>
              <table cellpadding="0" cellspacing="0" style="margin:0 0 40px;">
                <tr>
                  <td style="border-radius:100px;background-color:#E8523A;">
                    <a href="${SITE_URL}/find" style="display:inline-block;padding:14px 32px;font-family:Arial,sans-serif;font-size:12px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:#FAF7F2;text-decoration:none;">Pre-Order Now</a>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:24px 48px;background-color:#2C1A12;text-align:center;">
              ...
              <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;color:rgba(250,247,242,0.3);">You're receiving this because you signed up at drinkingdirtysoda.com</p>
            </td>
          </tr>
        </table>
      </td>
